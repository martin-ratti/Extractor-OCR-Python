...
1.  Descarga la última versión del `.exe` desde la sección de **[Releases](https://github.com/TU_USUARIO/Extractor-OCR-Python/releases)** de este repositorio.
...
```bash
git clone [https://github.com/TU_USUARIO/Extractor-OCR-Python.git](https://github.com/TU_USUARIO/Extractor-OCR-Python.git)
